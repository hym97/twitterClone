...
export default class UserLarge extends React.Component{
    ...
    test_data = {avatar:this.avatar_test, userName:this.userName_test, certified: this.certified_test}


    render() {
        // const {user} = this.props
        const {avatar, userName, certified, time,promoted} = this.test_data
